...
use backend\models\subscription\SubscriberSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SubscribersController implements the CRUD actions for Subscriber model.
 */
class SubscribersController extends Controller
{
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException(Yii::t('subscription/subscriber', 'The requested page does not exist.'));
    }
}
