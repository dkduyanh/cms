...
use backend\models\CronJobForm;
use Yii;
...
/**
 * CronjobsController implements the CRUD actions for Cronjob model.
 */
class CronjobsController extends BaseController
{
    ...
    public function actionUpdate($id)
    {
        ...
        $model->last_modifier_id = Yii::$app->user->id;
    ...
    {
        if (($model = CronJobForm::findOne($id)) !== null) {
            return $model;
        }
